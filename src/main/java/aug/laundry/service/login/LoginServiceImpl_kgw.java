...
//public class LoginServiceImpl_kgw implements LoginService {
...
//            System.out.println("=============================");
//
//            int checkRes = loginRepository.checkSocialId(response.get("id"));
//
//            // 첫 소셜로그인 -> 회원정보 DB에 저장
//            if(checkRes <= 0){
...
//
//                // DB에 등록
//                int registerUserInfoRes = loginRepository.registerSocialUser(memberDto);
//                int registerSocialNumRes = loginRepository.registerSocialNumber(response.get("id"));
//
...
//
//            int checkRes = loginRepository.checkSocialId(memberSocialId);
//
//            if(checkRes <= 0){
...
//
//                int registerUserInfoRes = loginRepository.registerSocialUser(memberDto);
//                int registerSocialNumRes = loginRepository.registerSocialNumber(memberSocialId);
//
...
//        int res = loginRepository.registerSocialUser(memberDto);
//
//        return res;
//    }
//
//    public int registerSocialNumber(String id){
//        int res = loginRepository.registerSocialNumber(id);
//
//        return res;
//    }
//
...
//
//        MemberDto member = loginRepository.login(memberDto.getMemberAccount());
//
//        if(member != null){
...
//        AdminDto adminDto = loginRepository.adminLogin(adminEmail, adminPassword);
//        return adminDto;
//    }
//
//    @Override
//    public RiderDto riderLogin(String riderEmail , String riderPassword) {
//        RiderDto riderDto = loginRepository.riderLogin(riderEmail, riderPassword);
//        return riderDto;
//    }
//
//    @Override
//    public QuickRiderDto quickRiderLogin(String quickRiderEmail, String quickRiderPassword) {
//        QuickRiderDto quickRiderDto = loginRepository.quickRiderLogin(quickRiderEmail, quickRiderPassword);
